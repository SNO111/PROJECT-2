                        ...
                        <div class="col-sm-9">
                            ...
                            <?php
                                ...
                                try {
                                    ...
                                    $stmt = $conn->prepare("SELECT *, SUM(quantity) AS total_qty FROM details 
                                                            LEFT JOIN sales ON 
                                                            sales.id = details.sales_id
                                                            LEFT JOIN products ON 
                                                            products.id = details.product_id
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="box box-solid">
                                                        <div class="box-body prod-body">
                                                            <img class="thumbnail" src=" ' . $image . '" width="100%" height="230px">
                            ...
                            <div class="recently-addedd">
                                ...
                                <?php 
                                    ...
                                    $conn = $pdo->open();
                                    try {
                                        $stmt = $conn->prepare("SELECT * FROM products ORDER BY id LIMIT 6");
                                        $stmt->execute();
