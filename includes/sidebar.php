            ...
            <form action="" method="POST">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <button class="btn btn-info btn-flat"><i class="fa fa-envelope"></i></button>
                    </span>
                </div>
            </form>
        </div>
...
<div class="row">
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            <a href="https://www.twitter.com/" class="btn btn-social-icon btn-twitter"><i class="fa fa-twitter"></i></a>
            <a href="https://www.instagram.com/" class="btn btn-social-icon btn-instagram"><i class="fa fa-instagram"></i></a>
            <a href="https://www.google.com/" class="btn btn-social-icon btn-google"><i class="fa fa-google-plus"></i></a>
