				...
				$output .= "
					<tr>
						...
						<td class='input-group'>
            				...
            				<input type='text' class='form-control text-center' value='".$row['quantity']."' id='qty_".$row['cartid']."'>
				            <span class='input-group-btn'>
				...
				$output .= "
					<tr>
						...
						<td class='input-group'>
            				...
            				<input type='text' class='form-control text-center' value='".$row['quantity']."' id='qty_".$row['productid']."'>
				            <span class='input-group-btn'>
